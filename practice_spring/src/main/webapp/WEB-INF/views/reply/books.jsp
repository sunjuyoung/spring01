...
$(document).ready(function(){
	...
	$.ajax({
		...
		success:function(result){
				console.log("booklist ajax success"); //author,  pubDate ,link, cover  ,categoryName
				console.log(result.item[0]);
				console.log(result.item[0].cover);
				
				console.log($("div.item").find("img"));
				
				$("div.item").find("img").attr("src",result.item[0].cover);
...
/* 	
	...
	bookAPIService.list(function(result){
...
<div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
      <div class="item active">
        <img src="" alt="New York" width="1200" height="700">
      ...
      <div class="item">
        <img src="" alt="Chicago" width="1200" height="700">
        <div class="carousel-caption">
          <h3>Chicago</h3>
      ...
      <div class="item">
        <img src="" alt="Los Angeles" width="1200" height="700">
        <div class="carousel-caption">
          <h3>LA</h3>
